...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('leads', {
      ...
      status: { type: Sequelize.ENUM('Draft', 'New', 'Contacted', 'Qualified', 'Negotiation', 'Converted', 'Rejected', 'Lost'), allowNull: false, defaultValue: 'New' },
    ...
    await queryInterface.createTable('orders', {
      ...
      required_date: { type: Sequelize.DATEONLY, allowNull: true },
      status: { type: Sequelize.ENUM('Draft', 'Pending', 'Confirmed', 'In Production', 'Ready', 'Dispatched', 'Delivered', 'Bill', 'Cancelled'), allowNull: false, defaultValue: 'Pending' },
    ...
    await queryInterface.createTable('bills', {
      ...
      grand_total: { type: Sequelize.DECIMAL(15, 2), allowNull: false, defaultValue: 0 },
      status: { type: Sequelize.ENUM('draft', 'final'), allowNull: false, defaultValue: 'final' },
