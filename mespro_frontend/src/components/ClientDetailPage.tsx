    ...
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="details" className="w-full">
        <TabsList className="grid w-full max-w-2xl grid-cols-5">
          <TabsTrigger value="details"><Building2 className="w-3.5 h-3.5 mr-1.5" /> Details</TabsTrigger>
          <TabsTrigger value="bills"><FileText className="w-3.5 h-3.5 mr-1.5" /> Bills ({bills.length})</TabsTrigger>
          <TabsTrigger value="orders"><Package className="w-3.5 h-3.5 mr-1.5" /> Orders ({orders.length})</TabsTrigger>
          <TabsTrigger value="outstandings"><CreditCard className="w-3.5 h-3.5 mr-1.5" /> Outstanding ({outstandings.length})</TabsTrigger>
          <TabsTrigger value="followups"><MessageSquare className="w-3.5 h-3.5 mr-1.5" /> Follow-ups ({followups.length})</TabsTrigger>
        </TabsList>
